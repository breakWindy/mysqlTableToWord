...
public class TableToWordUtil {
    public static String GEN_FILE_PATH = "/Users/luowen/workspace/code/java/my-app";
    private static String dbHost = "localhost";
    private static int dbPort = 3306;
    private static String dbName = "general_data_platform";
    private static String userName = "luowen";
    private static String password = "luowen123";
    ...
    private static void genTableStructDesc(Document document, List<TableInfo> tables, DataSource ds) throws DocumentException, SQLException {
        Paragraph ph = new Paragraph();
...
//        List<TableInfo> list = Lists.newArrayList();
        List<TableInfo> list = new ArrayList<>(); // Lists.newArrayList();
    ...
    private static List<TableFiled> getTableFields(DataSource ds, String tblName) throws SQLException {
        ...
        PreparedStatement stmt = null;
        ResultSet rs = null;
        List<TableFiled> list = new ArrayList<>(); //Lists.newArrayList();
        try {
            conn = ds.getConnection();
...
//            sql = "show columns FROM " + tblName;
    ...
    private static void setParameters(PreparedStatement stmt, List<String> parameters) throws SQLException {
